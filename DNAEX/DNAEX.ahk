...
PlayerSpeed := 1337flex.Read(baseAddress + offsets.GWorld, "float", 0x190, 0x38, 0x0, 0x30, 0x2D0, 0xC8)
if PlayerSpeed > 0.1
1337flex.write(baseAddress + offsets.GWorld, PlayerSpeed2,"float", 0x190, 0x38, 0x0, 0x30, 0x2D0, 0xC8)
1337flex := ""
Tooltip Speed 2,round(A_ScreenWidth * .5),0
Sleep 300
Tooltip
Return
...
1337flex := ""
Tooltip Speed 3,round(A_ScreenWidth * .5),0
Sleep 300
Tooltip
Return
