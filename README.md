...
- Speedhack(перемещение и атака)
- Рыбалка(Cheat Engine + Autohotkey)
...
XButton2 - Переключение "Скорость 6"
...
```
Рыбалка:
В игре сесть на рыбный спот и взять удочку
Запустить Cheat Engine, запустить таблицу "Instant FIsh.CT"
Запустить FIsh-2560-1440p.ahk (только для 2к монитора)
Нажать F4
Первая попытка мимо, дальше автомат
```
